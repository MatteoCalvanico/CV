...
\resumeSubHeadingListStart
  ...
  \item{
    \textbf{Frameworks \& Libraries}{: Vue, React, Jest, Zod, Mongoose, Serverless Application Model (SAM), Entity Framework, .NET, Bootstrap, TensorFlow, Scikit Learn, PyTorch, CUDA, OpenCV, Pandas, Numpy, Gradle.}
    \hfill
    }
  \item{
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {\href{https://corsi.unibo.it/1cycle/ComputerSystemTechnologies}{\underline{Bachelor's Degree in Computer System Technologies}}}{2022 -- 2025}
      \resumeItemListStart
    ...
    \resumeItemListStart
	\resumeItem{Description}{I have completed the high school with a specialization in Computer Science and Telecommunication Systems. I have studied the basics of programming, networking, electronics, and much more.}
    \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
    \resumeSubheading{DMA - CX Company for B2B}{Cesena (FC), Italy}{Intern Software Engineer}{Aprile 2025 -- Agosto 2025}
    \resumeItemListStart
        \resumeItem{Technologies used} {AWS (Cloudformation, Lambda, API Gateway, SQS, Timestream, IoT Core, EC2), React, Grafana, Docker, GitHub Actions, MongoDB Atlas}
        \resumeItem{Description}
        {The collaboration with \emph{DMA} led to the development of a \emph{Dashboard}, where customer service operators of companies relying on DMA for their software solutions can monitor the current and past status of various devices used by different consumers, in order to provide targeted and functional support in case of failures or problems of any kind. The creation of the dashboard was not straightforward; before beginning the design and development of the product, it was necessary to acquire new knowledge and consolidate existing one across various technologies. The process was step-by-step, involving the development of smaller projects with progressively increasing difficulty, which collectively gathered the various skills necessary for dashboard development.}
    \resumeItemListEnd
    \resumeSubheading{Maggioli S.P.A.}{Santarcangelo di Romagna (FC), Italy}{Intern Software Engineer}{November 2024 -- March 2025}
    \resumeItemListStart
        \resumeItem{Technologies used} {Angular, Java, Spring, Postman, Docker, MongoDB, GitLab}
        \resumeItem{Description}
        {Italian company that provides software solutions for public administration. Working as a Full-Stack programmer I learned to move in an already established code base and to work in a large team, learning how to deal with the daily problems that can arise at any time in a large and dynamic company.}
    \resumeItemListEnd
\resumeSubHeadingListEnd
...
\section{Projects}
  ...
  \resumeSubItem{ECC Dashboard}
      {Cloud-based application for customer support.}
  \resumeItemListStart
    \resumeItem{AWS}{the application, in its back-end part, uses various technologies from the AWS suite to function. Among these: \textbf{IoT Core} to retrieve data from field devices, \textbf{Timestream} to save incoming data, \textbf{Lambda} to perform operations on data sources and more.}
    \resumeItem{Grafana and React}{the front-end is divided into two parts. The dashboard uses Grafana to display data sent by devices, with the ability to filter and view past data. The portal with information about devices, users, and alarms is displayed through an application developed in React.}
    \resumeItem{Automated Deployment}{the entire cloud infrastructure and front-end application are deployed through an automated process created using GitHub Actions.}
    \resumeItem{Thesis}{the design and development of the entire application were documented in my bachelor's thesis.}
  \resumeItemListEnd
...
\resumeSubItem{\href{https://github.com/MatteoCalvanico/ProtoCRPG}{ProtoCRPG}}
      {Prototype of a CRPG developed in Godot 4.3 as a starting point for similar games.}
	\resumeItemListStart
		 \resumeItem{Project based learning}{the goal of the project is to learn not only the technology itself (Godot Engine and GDScript) but also how to work on a real game, with all the problems of the case.}
		\resumeItem{Passion}{lThe ultimate goal is to have a usual base to start working, in the future, on my own isometric role-playing game, following in the footsteps of old classics such as Fallout and Baldur's Gate.}
		\resumeItem{Why Godot?}{the choice of this Game Engine is not accidental, the decision to choose an open source tool is due to the possibility of being free to experiment and also study how these technologies work behind the scenes.}
	\resumeItemListEnd
  \resumeSubHeadingListEnd
