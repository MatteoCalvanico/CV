...
\resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        {Azienda italiana specializzata in sviluppo di applicazioni per la pubblica amministrazione. Personalmente mi sono occupato dello sviluppo front e backend, imparando a lavorare in un grande team e muovermi in una codebase già consolidata e grande.}
    \resumeItemListEnd
\resumeSubHeadingListEnd
...
\resumeSubItem{\href{https://github.com/MatteoCalvanico/ProtoCRPG}{ProtoCRPG}}
      {Prototipo di un CRPG sviluppato in Godot 4.3 come punto di partenza per giochi simili e per imparare l'Engine e il linguaggio.}
	\resumeItemListStart
